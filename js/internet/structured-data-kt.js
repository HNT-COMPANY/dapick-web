...
(function () {
  ...
  const data = {
    ...
    '@graph': [
      ...
      {
        '@type': 'WebPage',
        '@id': 'https://dapick.co.kr/internet-kt.html#webpage',
        url: 'https://dapick.co.kr/internet-kt.html',
        name: 'KT 인터넷·TV 지원금 비교 | 다픽',
        description:
          'KT 인터넷·TV 실제 정책 기준 지원금 비교. 기가 인터넷, 지니TV 결합 사은품 최대 50만원. 무료 상담 신청까지.',
        inLanguage: 'ko-KR',
        isPartOf: {
          '@id': 'https://dapick.co.kr/#organization',
        },
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: 'KT',
            item: 'https://dapick.co.kr/internet-kt.html',
          },
        ],
      },
      {
        '@type': 'Service',
        serviceType: 'KT 인터넷·TV 가입 상담',
        provider: {
          '@id': 'https://dapick.co.kr/#organization',
        },
        areaServed: {
        ...
        offers: {
          ...
          highPrice: '64900',
          offerCount: '5',
          description: 'KT 인터넷·TV 요금제 (3년 약정 기준)',
        },
      },
    ],
  };
